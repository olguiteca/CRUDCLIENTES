...
public class ClienteVer {
	...
	public void cuandoFindByIdEntoncesTieneTodosSusDatos() {
		Cliente rut = this.dao.findById("18350689-4").get();
		Cliente rutOriginal = new Cliente("18350689-4", "Pedro", "Pedreros", "pedro@email.com", "(+569)0303456");
		boolean sonIguales = rut.equals(rutOriginal);
