...
public class ClienteModificar {
	...
	@Test
	public void cuandoModificaNombreEntoncesSeObtieneModificado() {
		this.dao.save(new Cliente("13589741-8", "Luzmenia", "Villarroel", "luz.vi@ejecutiva.com", "(+569)96581254"));
		Cliente luz = this.dao.findById("13589741-8").get();
		assertTrue("Ahora es " + luz.getNombres() + " Luzmira debería ser Luzmenia ", luz.getNombres().equals("Luzmenia"));
	}
